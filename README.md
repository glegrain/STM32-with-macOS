...
- [0 - Installing the toolchain](#0---installing-the-toolchain)
  - [Requirements:](#requirements)
- [1 - Create a Project using CubeMX](#1---create-a-project-using-cubemx)
- [2 - Configure your Makefile](#2---configure-your-makefile)
- [3 - Building your project](#3---building-your-project)
- [4 - Programming the board](#4---programming-the-board)
  - [Option 1 - Using STM32CubeProgrammer GUI:](#option-1---using-stm32cubeprogrammer-gui)
  - [Option 1.1 - Using STM32CubeProgrammer CLI:](#option-11---using-stm32cubeprogrammer-cli)
  - [Option 2 - Using texane stlink:](#option-2---using-texane-stlink)
  - [Option 3 - Using OpenOCD:](#option-3---using-openocd)
- [5 - Debugging](#5---debugging)
  - [Step 1 - Start a GDB server](#step-1---start-a-gdb-server)
    - [Option 1.1 - Using texane stlink](#option-11---using-texane-stlink)
    - [Option 1.2 - Using OpenOCD](#option-12---using-openocd)
  - [Step 2 - Launch GDB:](#step-2---launch-gdb)
  - [Step 3 - Using GDB](#step-3---using-gdb)
  - [Program stepping/execution:](#program-steppingexecution)
  - [Setting a breakpoint:](#setting-a-breakpoint)
  - [Inspecting and setting variables and memory:](#inspecting-and-setting-variables-and-memory)
  - [Manipulating registers:](#manipulating-registers)
  - [Viewing the call stack:](#viewing-the-call-stack)
  - [Restarting/reset:](#restartingreset)
  - [Looking at the code (useful when TUI mode is disabled):](#looking-at-the-code-useful-when-tui-mode-is-disabled)
  - [Show next assembly instructions:](#show-next-assembly-instructions)
  - [Getting help:](#getting-help)
  - [Other/Advanced GDB:](#otheradvanced-gdb)
- [Editing your Makefile](#editing-your-makefile)
  - [Adding source files:](#adding-source-files)
  - [Adding Includes:](#adding-includes)
  - [Adding Preprocessor defines:](#adding-preprocessor-defines)
  - [Changing optimization options:](#changing-optimization-options)
  - [Understanding compiler options and flags:](#understanding-compiler-options-and-flags)
- [Serial console:](#serial-console)
  - [Using semihosting:](#using-semihosting)
  - [Using UART:](#using-uart)
    - [Option 1 - GNU Screen](#option-1---gnu-screen)
    - [Option 2 - Minicom](#option-2---minicom)
  - [Using ITM messages over SWO:](#using-itm-messages-over-swo)
- [Other Resources:](#other-resources)
- [Issues:](#issues)
- [Debugging tips (Part 2?)](#debugging-tips-part-2)
